<?php
/**
 * The html header of our template
 *
...
?>
<?php /* Modernizr for feature detection and load jQuery from Google CDN */ ?>
  <script src="<?php echo $template->get_template_dir('.js',DIR_WS_TEMPLATE, $current_page_base,'jscript'); ?>/vendor/modernizr-2.8.3.min.js"></script>
  <script>window.jQuery || document.write('<script src="//ajax.googleapis.com/ajax/libs/jquery/jquery-1.11.1.min.js"><\/script>');</script>
